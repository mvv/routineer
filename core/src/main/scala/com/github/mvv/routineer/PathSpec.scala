...
object PathSpec {
  ...
  sealed trait ElemsOps[E0 <: Elems] {
    ...
    def prependElem[H](head: Elem[H], elems: E0)(implicit hasNext: E0#HasNext =:= TTrue): E0#Prepend[H]
    def appendElem[L](elems: E0, last: Elem[L])(implicit hasNext: E0#HasNext =:= TTrue): E0#Append[L]
    def prependArg[H](head: H, args: E#Args)(implicit hasNext: E0#HasNext =:= TTrue): E0#Prepend[H]#Args
    def appendArg[L](args: E0#Args, last: L)(implicit hasNext: E0#HasNext =:= TTrue): E0#Append[L]#Args
  }
  object ElemsOps {
  ...
  object ElemsOps0 extends ElemsOps[Elems0] {
    ...
    def andThen[R, R1](f: Unit => R, g: R => R1): Unit => R1 = _ => g(f(()))
    def prependElem[H](head: Elem[H], elems: E)(implicit hasNext: E#HasNext =:= TTrue) = Elems1(head)
    def appendElem[L](elems: E, last: Elem[L])(implicit hasNext: E#HasNext =:= TTrue) = Elems1(last)
    def prependArg[H](head: H, args: Unit)(implicit hasNext: E#HasNext =:= TTrue) = head
    def appendArg[L](args: Unit, last: L)(implicit hasNext: E#HasNext =:= TTrue) = last
  }
  ...
  final class ElemsOps1[A]() extends ElemsOps[Elems1[A]] {
    def apply[R](f: E#Func[R], args: E#Args): R = f(args)
    def andThen[R, R1](f: E#Func[R], g: R => R1): A => R1 = x => g(f(x))
    def prependElem[H](head: Elem[H], elems: E)(implicit hasNext: E#HasNext =:= TTrue) =
      Elems2(head, elems._1)
    def appendElem[L](elems: E, last: Elem[L])(implicit hasNext: E#HasNext =:= TTrue) =
      Elems2(elems._1, last)
    def prependArg[H](head: H, args: E#Args)(implicit hasNext: E#HasNext =:= TTrue) =
      (head, args)
    def appendArg[L](args: E#Args, last: L)(implicit hasNext: E#HasNext =:= TTrue) =
      (args, last)
  }
  ...
  final case class Elems3[A1, A2, A3](_1: Elem[A1], _2: Elem[A2], _3: Elem[A3]) extends Elems {
    type Args = (A1, A2, A3)
    type HasNext = TTrue
  ...
  final case class Elems4[A1, A2, A3, A4](_1: Elem[A1], _2: Elem[A2], _3: Elem[A3], _4: Elem[A4]) extends Elems {
  ...
  final class ElemsOps4[A1, A2, A3, A4] extends ElemsOps[Elems4[A1, A2, A3, A4]] {
    def apply[R](f: E#Func[R], args: E#Args) = f.tupled(args)
    def andThen[R, R1](f: E#Func[R], g: R => R1) =
  ...
  final case class Elems5[A1, A2, A3, A4, A5](_1: Elem[A1], _2: Elem[A2], _3: Elem[A3], _4: Elem[A4], _5: Elem[A5])
      extends Elems {
  ...
  final class ElemsOps5[A1, A2, A3, A4, A5] extends ElemsOps[Elems5[A1, A2, A3, A4, A5]] {
    def apply[R](f: E#Func[R], args: E#Args) = f.tupled(args)
    def andThen[R, R1](f: E#Func[R], g: R => R1) =
  ...
  final case class Elems6[A1, A2, A3, A4, A5, A6](_1: Elem[A1],
                                                  _2: Elem[A2],
                                                  _3: Elem[A3],
                                                  _4: Elem[A4],
                                                  _5: Elem[A5],
  ...
  final class ElemsOps6[A1, A2, A3, A4, A5, A6] extends ElemsOps[Elems6[A1, A2, A3, A4, A5, A6]] {
    def apply[R](f: E#Func[R], args: E#Args) = f.tupled(args)
    def andThen[R, R1](f: E#Func[R], g: R => R1) =
  ...
  final case class Elems7[A1, A2, A3, A4, A5, A6, A7](_1: Elem[A1],
                                                      _2: Elem[A2],
                                                      _3: Elem[A3],
                                                      _4: Elem[A4],
                                                      _5: Elem[A5],
  ...
  final class ElemsOps7[A1, A2, A3, A4, A5, A6, A7] extends ElemsOps[Elems7[A1, A2, A3, A4, A5, A6, A7]] {
    def apply[R](f: E#Func[R], args: E#Args) = f.tupled(args)
    def andThen[R, R1](f: E#Func[R], g: R => R1) =
      (x1, x2, x3, x4, x5, x6, x7) => g(f(x1, x2, x3, x4, x5, x6, x7))
    def prependElem[H](head: Elem[H], elems: E)(implicit hasNext: E#HasNext =:= TTrue) =
      Elems8(head, elems._1, elems._2, elems._3, elems._4, elems._5, elems._6, elems._7)
    def appendElem[L](elems: E, last: Elem[L])(implicit hasNext: E#HasNext =:= TTrue) =
      Elems8(elems._1, elems._2, elems._3, elems._4, elems._5, elems._6, elems._7, last)
    def prependArg[H](head: H, args: E#Args)(implicit hasNext: E#HasNext =:= TTrue) =
      (head, args._1, args._2, args._3, args._4, args._5, args._6, args._7)
    def appendArg[L](args: E#Args, last: L)(implicit hasNext: E#HasNext =:= TTrue) =
      (args._1, args._2, args._3, args._4, args._5, args._6, args._7, last)
  }
  final case class Elems8[A1, A2, A3, A4, A5, A6, A7, A8](_1: Elem[A1],
                                                          _2: Elem[A2],
                                                          _3: Elem[A3],
                                                          _4: Elem[A4],
                                                          _5: Elem[A5],
  ...
  final class ElemsOps8[A1, A2, A3, A4, A5, A6, A7, A8] extends ElemsOps[Elems8[A1, A2, A3, A4, A5, A6, A7, A8]] {
    def apply[R](f: E#Func[R], args: E#Args): R = f.tupled(args)
    def andThen[R, R1](f: E#Func[R], g: R => R1) =
...
final class PathSpecAndCond[Req, Elems <: PathSpec.Elems](path: PathSpec[Elems],
                                                          cond: Elems#Prepend[Req]#Func[Boolean]) {
  def when[Resp](body: Elems#Prepend[Req]#Func[Resp])(implicit hasNext: Elems#HasNext =:= PathSpec.TTrue,
                                                      ops: PathSpec.ElemsOps[Elems],
                                                      prepOps: PathSpec.ElemsOps[Elems#Prepend[Req]]) =
    CondRoute(path, cond, body)
  def whenDo[Resp](body: Elems#Prepend[Req]#Func[Resp])(implicit hasNext: Elems#HasNext =:= PathSpec.TTrue,
                                                        ops: PathSpec.ElemsOps[Elems],
                                                        prepOps: PathSpec.ElemsOps[Elems#Prepend[Req]]) =
    CondRoute(path, cond, body)
}
final class PathSpecAndGuard[Req, Elems <: PathSpec.Elems, E](path: PathSpec[Elems],
  ...
  def when[Resp](body: Elems#Prepend[Req]#Append[E]#Func[Resp])(
      ...
      ops: PathSpec.ElemsOps[Elems],
      prepOps: PathSpec.ElemsOps[Elems#Prepend[Req]],
      prepApOps: PathSpec.ElemsOps[Elems#Prepend[Req]#Append[E]]
  ) =
...
sealed trait PathSpec[Elems <: PathSpec.Elems] {
  ...
  ): SimpleRoute[Req, Resp, Elems] =
    SimpleRoute(this, body)
  def whenDo[Req, Resp](
      body: Elems#Prepend[Req]#Func[Resp]
  )(implicit hasNext: Elems#HasNext =:= PathSpec.TTrue, ops: ElemsOps[Elems], prepOps: ElemsOps[Elems#Prepend[Req]]) =
    SimpleRoute(this, body)
...
final case class SimplePathSpec[Elems <: PathSpec.Elems](elems: Elems, suffix: Seq[String]) extends PathSpec[Elems] {
  def />(str: String) = SimplePathSpec(elems, suffix :+ str)
  def />[R](matcher: Pattern[String, R])(implicit hasNext: Elems#HasNext =:= PathSpec.TTrue,
                                         ops: PathSpec.ElemsOps[Elems],
                                         apOps: PathSpec.ElemsOps[Elems#Append[R]]) =
    SimplePathSpec(ops.appendElem(elems, PathSpec.Elem(suffix, matcher)), Seq.empty)
  def /#[R](matcher: Pattern[String, R])(implicit hasNext: Elems#HasNext =:= PathSpec.TTrue) =
